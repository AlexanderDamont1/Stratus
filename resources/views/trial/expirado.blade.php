    ...
    <div class="min-h-[80vh] flex items-center justify-center px-4">
        <div class="max-w-md w-full text-center space-y-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 text-left space-y-4">
                ...
                <div class="flex flex-col gap-3">
                    <div class="flex gap-3 items-start">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                            Tu periodo de prueba de <strong class="font-medium text-gray-800 dark:text-gray-200">15 días</strong> ha concluido. 
                            Si te gustó el sistema y deseas continuar usando todas las funcionalidades, 
                            contáctanos a través de WhatsApp para conocer los planes disponibles.
                        </p>
                    </div>
                ...
                <div class="pt-1">
                    <a href="https://wa.me/5215511743162?text=Me%20encanto%20el%20sistema%20ArrowK%2C%20quisiera%20m%C3%A1s%20informes"
                       target="_blank"
