{{-- resources/views/cotizacion/expirada.blade.php --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon { width: 60px; height: 60px; background: #fff7ed; border-radius: 50%; font-size: 28px; line-height: 60px; margin: 0 auto 20px; }
...
<div class="card">
    ...
    <p>
        Este enlace ya no está disponible. No te preocupes — nuestro equipo se
        comunicará contigo directamente para resolver tu orden.
    </p>
</div>
</body>
</html>
...
{{-- ══════════════════════════════════════════════════════════════════════════ --}}
{{-- NOTA: este archivo contiene DOS vistas. Copia la segunda sección          --}}
{{-- a resources/views/cotizacion/ya_respondida.blade.php                      --}}
{{-- ══════════════════════════════════════════════════════════════════════════ --}}