        ...
        <nav class="flex-1 px-3 py-4 space-y-1 text-sm overflow-y-auto">
            ...
            @if(auth()->user()->id_rol === 1)
                ...
                <div x-data="{ catalogoOpen: {{ $catalogoActivo ? 'true' : 'false' }} }">
                    ...
                    <button
                        @click="catalogoOpen = !catalogoOpen"
                        class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                            {{ $catalogoActivo
                                ? 'bg-gray-900 text-white dark:bg-white dark:text-gray-900'
                                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
    ...
    <div
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            <div x-show="step === 1"
                ...
                <button @click="step = 2" class="w-full bg-gray-900 dark:bg-white dark:text-gray-900 text-white py-3 rounded-xl font-bold hover:opacity-90 transition shadow-lg">
