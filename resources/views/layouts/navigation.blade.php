...
<div x-data="{ open: false }" class="flex overflow-hidden bg-gray-50 dark:bg-gray-950"
    ...
    <aside x-cloak class="fixed lg:static inset-y-0 left-0 z-40
               ...
               shadow-xl lg:shadow-none" :class="open ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 text-sm overflow-y-auto">
            {{-- Inicio --}}
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
    ...
    : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
            ...
            @if(Auth::user()->id_rol === 0)
                    <a href="{{ route('root.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
            ...
            <a href="{{ route('administrador.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
        ...
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
            ...
            <a href="{{ route('admin.garantias.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
        ...
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
            ...
            {{-- Personal --}}
            <a href="{{ route('admin.personal.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
         {{ request()->routeIs('admin.personal.*')
        ? 'bg-gray-900 text-white dark:bg-white dark:text-gray-900'
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}" @click="open = false">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            {{-- Métodos de pago --}}
            <a href="{{ route('admin.metodos_pago.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
        ...
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}" @click="open = false">
            ...
            <a href="{{ route('admin.cupones.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
        ...
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
            ...
            <div x-data="{ InventarioOpen: {{ $inventarioActivo ? 'true' : 'false' }} }">
                <button @click="InventarioOpen = !InventarioOpen" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                               {{ $inventarioActivo
        ? 'bg-gray-900 text-white dark:bg-white dark:text-gray-900'
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    ...
                    <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200"
                        :class="InventarioOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>

                <div x-show="InventarioOpen" x-cloak x-transition:enter="transition ease-out duration-200"
                    ...
                    <a href="#" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
                    ...
                    <a href="{{ route('admin.productos.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
                              {{ request()->routeIs('admin.productos.index')
        ...
        : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                    ...
                    <a href="{{ route('bicicletas.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
        ...
        : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                    ...
                    @modulo('tracking')
                    <a href="{{ route('admin.movimientos.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
        ...
        : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
            ...
            <div x-data="{ catalogoOpen: {{ $catalogoActivo ? 'true' : 'false' }} }">
                <button @click="catalogoOpen = !catalogoOpen" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                               {{ $catalogoActivo
        ? 'bg-gray-900 text-white dark:bg-white dark:text-gray-900'
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200"
                        :class="catalogoOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>

                <div x-show="catalogoOpen" x-cloak x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 -translate-y-1"
                    x-transition:enter-end="opacity-100 translate-y-0"
                    x-transition:leave="transition ease-in duration-150"
                    x-transition:leave-start="opacity-100 translate-y-0"
                    ...
                    <a href="{{ route('admin.catalogo.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
        ...
        : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                    ...
                    <a href="{{ route('admin.catalogo.voltajes.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
        ...
        : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
            ...
            @if(auth()->user()->id_rol === 2)
                    <a href="{{ route('stock.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                ...
                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                    ...
                    <a href="{{ route('ventas.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                ...
                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                    ...
                    <a href="{{ route('garantias.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                ...
                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                    ...
                    <a href="{{ route('sucursal.productos.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
            ...
            @if(auth()->user()->id_rol === 5)
                    <a href="{{ route('gestor.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition active:scale-95
                ...
                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                    ...
                    <div x-data="{ stockOpen: {{ $stockActivo ? 'true' : 'false' }} }">
                        <button @click="stockOpen = !stockOpen" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition
                                       {{ $stockActivo
                ? 'bg-gray-900 text-white dark:bg-white dark:text-gray-900'
                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200"
                                :class="stockOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>

                        <div x-show="stockOpen" x-cloak x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 -translate-y-1"
                            x-transition:enter-end="opacity-100 translate-y-0"
                            x-transition:leave="transition ease-in duration-150"
                            x-transition:leave-start="opacity-100 translate-y-0"
                ...
                : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                            ...
                            <a href="{{ route('gestor.vehiculos.modelos.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
                                      {{ request()->routeIs('gestor.vehiculos.modelos.*')
                ? 'bg-gray-100 dark:bg-gray-700 font-semibold text-gray-900 dark:text-white'
                : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                                @click="open = false">
                            ...
                            <a href="{{ route('gestor.vehiculos.colores.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
                                      {{ request()->routeIs('gestor.vehiculos.colores.*')
                ? 'bg-gray-100 dark:bg-gray-700 font-semibold text-gray-900 dark:text-white'
                : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                                @click="open = false">
                            ...
                            <a href="{{ route('gestor.vehiculos.voltajes.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
                                      {{ request()->routeIs('gestor.vehiculos.voltajes.*')
                ? 'bg-gray-100 dark:bg-gray-700 font-semibold text-gray-900 dark:text-white'
                : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                                @click="open = false">
                            ...
                            <a href="{{ route('modelo-voltaje') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition
                                      {{ request()->routeIs('modelo-voltaje')
                ? 'bg-gray-100 dark:bg-gray-700 font-semibold text-gray-900 dark:text-white'
                : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if(auth()->user()->id_rol === 1)
            @modulo('pedidos')
            <a href="{{ route('pedidos.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
        ...
        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
            ...
            @if(auth()->user()->id_rol === 1)
                    ...
                    <a href="{{ route('admin.config.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
            ...
            <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <header class="lg:hidden h-16 flex items-center px-4 bg-white dark:bg-gray-800
            ...
            <button @click="open = !open" class="p-2 -ml-2 text-gray-600 dark:text-gray-400
                           hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition" aria-label="Menú">
    ...
    <div x-data="{ step: {{ (Auth::user()->welcome_pending ?? true) ? 1 : 2 }} }"
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            <div x-show="step === 1" x-transition:enter="transition ease-out duration-300"
                x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" class="relative w-full max-w-md bg-white dark:bg-gray-900 border
                ...
                <button @click="step = 2" class="w-full bg-gray-900 dark:bg-white dark:text-gray-900 text-white
            ...
            <div x-show="step === 2" x-transition:enter="transition ease-out duration-300"
                x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" class="relative w-full max-w-2xl bg-white dark:bg-gray-900 border
                ...
                <form method="POST" action="{{ route('admin.setup.completar') }}" class="space-y-6"
                            ...
                            bg-gray-50/50 dark:bg-gray-800/50">
                                ...
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <div class="sm:col-span-2">
                                        <input type="text" name="vendedores[{{ $i }}][nombre]" placeholder="Nombre Sucursal"
                                            class="w-full rounded-lg border-gray-300 dark:bg-gray-700
                                          dark:text-white focus:ring-gray-900 text-sm sm:text-base" required>
                                    </div>
                                    <input type="email" name="vendedores[{{ $i }}][correo]" placeholder="Email de acceso" class="w-full rounded-lg border-gray-300 dark:bg-gray-700
                                      dark:text-white focus:ring-gray-900 text-sm sm:text-base" required>

                                    <div class="relative" x-data="{ showPassword: false }">
                                        <input :type="showPassword ? 'text' : 'password'" name="vendedores[{{ $i }}][password]"
                                            placeholder="Contraseña" class="w-full rounded-lg border-gray-300 dark:bg-gray-700
                                          dark:text-white focus:ring-gray-900 text-sm sm:text-base pr-10" required>
                                        <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center px-3
                    ...
                    <div class="pt-4 border-t dark:border-gray-800 flex gap-3">
                        <button type="submit" :disabled="submitting" class="flex-1 bg-gray-900 dark:bg-white dark:text-gray-900 text-white
