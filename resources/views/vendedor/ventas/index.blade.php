<x-app-layout>
    <div class="space-y-6">
        ...
        @if(session('success'))
            <div
                class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-400 text-sm px-4 py-3 rounded-lg flex items-center gap-2">
                        ...
                        @forelse($ventas as $venta)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span
                                        class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-700 text-xs font-semibold text-gray-600 dark:text-gray-300">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        @if($tieneBici)
    <button
        onclick="openPreview('{{ $tienePoliza 
            ? route('ventas.poliza', $venta->id_venta) 
            : route('ventas.ticket', $venta->id_venta) }}')"
