                ...
                <div class="flex-1 min-h-0 grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x
                    ...
                    <div class="flex flex-col overflow-y-auto">
                        <div class="p-5 space-y-4">
                            ...
                            {{-- Área de cámara: solo visible cuando scannerActivo --}}
                            <div x-show="scannerActivo" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div class="flex items-center justify-between mt-2">
                                    ...
                                    <button @click="detenerCamara()"
                                        class="text-xs text-gray-400 hover:text-red-500 dark:hover:text-red-400
                                            transition font-medium flex items-center gap-1">
                            ...
                            <div x-show="!scannerActivo"
                                class="w-full rounded-xl border border-dashed border-gray-200
                                ...
                                @click="activarCamara()">
                                <div class="w-10 h-10 rounded-xl bg-white dark:bg-gray-700 border
                                            border-gray-200 dark:border-gray-600 flex items-center
                                            justify-center shadow-sm group-hover:scale-105 transition">
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        <svg x-show="buscando" class="animate-spin w-3.5 h-3.5"
