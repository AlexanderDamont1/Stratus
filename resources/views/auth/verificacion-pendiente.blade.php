...
<div class="w-full max-w-4xl" x-data="vpSetup()">

    <div class="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden
        ...
        <div class="bg-white dark:bg-gray-800 flex flex-col justify-between px-10 py-10">
            <div>
                ...
                {{-- Marca --}}
                <div class="mb-9">
                    <p class="text-sm font-semibold tracking-tight text-gray-900 dark:text-white">ArrowK</p>
                ...
                <div class="inline-flex items-center gap-2
                            ...
                            text-xs font-medium px-3 py-1.5 rounded-full mb-5">
                    <span class="w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0"></span>
                    Verificación requerida
                </div>

                <h1 class="text-[1.65rem] font-semibold leading-tight tracking-tight
                            text-gray-900 dark:text-white mb-3">
                    Verifica tu<br>correo electrónico
                </h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-9">
                    Te enviamos un enlace de verificación. Ábrelo desde tu bandeja
                    para activar tu cuenta y acceder al panel.
                </p>
                ...
                <ul class="vp-steps list-none space-y-0">
                    ...
                    <li class="flex items-start gap-3">
                        <div class="w-[29px] h-[29px] rounded-full shrink-0 mt-0.5
                                    bg-gray-100 dark:bg-gray-700
                                    border border-gray-200 dark:border-gray-600
                                    flex items-center justify-center">
                            <svg class="w-[13px] h-[13px] text-gray-400 dark:text-gray-500"
                                 fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      stroke-width="2" d="{{ $step['icon'] }}"/>
                            </svg>
                        </div>
                        <div>
            ...
            {{-- Usuario + logout --}}
            <div class="flex items-center gap-3 pt-7 mt-7
        ...
        <div class="bg-gray-50 dark:bg-gray-900
            ...
            {{-- Cuerpo central --}}
            <div class="flex-1 flex flex-col items-center justify-center px-10 py-12 text-center">

                {{-- Sobre con badge pulsante --}}
                <div class="relative mb-8">
                    <div class="w-[88px] h-[88px] rounded-[20px]
                    ...
                    <span class="vp-pulse absolute -top-1.5 -right-1.5 w-[22px] h-[22px]
                                 rounded-full bg-amber-400 flex items-center justify-center">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 font-mono
                            bg-white dark:bg-gray-800
                            border border-gray-200 dark:border-gray-700
                            rounded-lg px-4 py-2 mb-8 truncate max-w-full">
                    {{ Auth::user()->correo }}
                </div>
                    ...
                    <form method="POST" action="{{ route('verificacion.reenviar') }}"
                        ...
                        <button type="submit"
                            ...
                            class="w-full flex items-center justify-center gap-2
                                   ...
                                   text-sm font-medium py-[10px] rounded-xl
                ...
                <div x-show="enviado" x-cloak class="w-full">
                    <div class="flex items-center justify-center gap-2
                                ...
                                text-sm font-medium px-4 py-[11px] rounded-xl">
            ...
            {{-- Footer hint --}}
            <div class="px-6 py-3.5 bg-white dark:bg-gray-800
                        border-t border-gray-200 dark:border-gray-700
                        flex items-start gap-2">
                <svg class="w-3.5 h-3.5 text-gray-400 mt-0.5 shrink-0"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <span class="text-xs text-gray-400 leading-relaxed">
                    El enlace expira en 24 horas. Si ya verificaste, recarga la página.
                </span>
            </div>
        </div>
