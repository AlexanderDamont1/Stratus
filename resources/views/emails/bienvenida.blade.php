                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="display:inline-block;">
                                            <tr>
                                                <td align="center" bgcolor="#020617" style="background:#020617; border-radius:12px;">
                                                    <a href="{{ route('dashboard') }}" style="display:inline-block; background:#020617; color:#ffffff; font-size:14px; font-weight:600; text-decoration:none; padding:12px 28px; border-radius:12px; letter-spacing:-0.01em; line-height:1.4; font-family:'Figtree','Inter',sans-serif !important;" target="_blank">
                                                        Acceder al panel
                                                    </a>
                                                </td>
                                            </tr>
