                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            ...
                            <td class="px-4 py-3 text-center">
                                <span @class([ 'text-xs font-medium px-2.5 py-1 rounded-full' , 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400'=> $enlace->estado === 'pendiente',
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                @elseif($enlace->estado === 'cancelado')
                                <form method="POST" action="{{ route('enlaces.activar', $enlace->id_enlace) }}" class="inline">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="text-green-600 hover:text-green-800 dark:text-green-400 font-semibold text-sm">
                                        Activar
                                    </button>
                                </form>
                                @else
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                            ...
                            <td class="px-3 py-3 text-center">
                                <span @class([ 'text-xs font-medium px-2 py-0.5 rounded-full' , 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400'=> $enlace->estado === 'pendiente',
                                    'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' => $enlace->estado === 'activo',
                                    'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' => $enlace->estado === 'cancelado',
                                    ])>
                                    {{ ucfirst($enlace->estado) }}
                            ...
                            <td class="px-3 py-3 text-center">
                                ...
                                <form method="POST" action="{{ route('enlaces.activar', $enlace->id_enlace) }}" class="inline">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="text-green-600 hover:text-green-800 dark:text-green-400 text-xs font-semibold">
                                        Activar
                                    </button>
                                </form>
                                @else
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg bg-red-100 dark:bg-red-900/30 flex items-center justify-center shrink-0">
                            <svg class="w-4 h-4 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1M10 14L14 10" />
                            </svg>
                        </div>
