...
>
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Modelos</h2>
            <p class="text-xs text-gray-400 mt-0.5">Gestiona los modelos de bicicletas del catálogo</p>
        </div>
        <button
    ...
    <div class="grid grid-cols-3 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-5 py-4">
            <p class="text-xs text-gray-400 uppercase tracking-wider mb-1">Total modelos</p>
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $modelos->total() }}</p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-5 py-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-5 py-4">
            ...
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $modelos->currentPage() }}<span class="text-sm font-normal text-gray-400 ml-1">/{{ $modelos->lastPage() }}</span></p>
        </div>
    </div>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
    <div class="px-6 py-4 border-b dark:border-gray-700 flex items-center justify-between">
        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Modelos registrados</h3>
        <span class="text-xs text-gray-400">{{ $modelos->total() }} total</span>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            ...
                            <td class="px-4 py-3 text-gray-900 dark:text-white font-medium">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span>{{ $modelo->nombre_modelo }}</span>
                                </div>
                            </td>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <div class="text-xs font-medium text-gray-900 dark:text-white">
                                            {{ Str::limit($modelo->nombre_modelo, 20) }}
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="3" class="px-3 py-8 text-center text-gray-500 dark:text-gray-400">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-xs">No hay modelos</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    <!-- Cards para móvil (alternativa más visual) -->
    ...
    >
        ...
        >
            <div class="flex items-start gap-4 mb-5">
                ...
                <div>
                    <h3 class="text-base font-semibold text-gray-900 dark:text-white">Eliminar modelo</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Vas a eliminar el modelo
