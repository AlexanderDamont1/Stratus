...
<div
    ...
    <div x-show="flashVisible" x-cloak
        ...
        <div class="flex items-center gap-2.5 rounded-xl bg-white dark:bg-gray-900 border px-4 py-3 shadow-xl text-sm font-medium"
            ...
            <svg x-show="flashTipo === 'success'" class="h-4 w-4 text-emerald-500 shrink-0" fill="currentColor" viewBox="0 0 20 20">
