...
<div class="mx-auto space-y-7" x-data="cuponesPage()" x-init="init()">
    ...
    <div x-show="crearModal" x-cloak
        ...
        <div x-show="crearModal"
            ...
            <div class="px-6 py-5 space-y-5 max-h-[70vh] overflow-y-auto">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">
                            Código
                            <button type="button" @click="generarCodigo()" class="ml-1 text-[10px] text-gray-400 hover:text-gray-600 underline">generar</button>
                        </label>
                ...
                {{-- Aplica a --}}
                <div>
                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-2">Aplica al</label>
                    <div class="grid grid-cols-2 gap-2">
                        <button type="button" @click="form.aplica_a = 'total'"
                            ...
                            class="flex items-center gap-2 border rounded-lg px-3 py-2.5 text-xs font-medium transition active:scale-95">
                    ...
                    <div class="space-y-2">
                        <template x-for="(regla, idx) in form.reglas" :key="idx">
                            <div class="flex items-start gap-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                                ...
                                {{-- Regla de sucursal — fija, no se puede quitar --}}
                                ...
                                <template x-if="regla.tipo !== 'sucursal'">
                                    <div class="flex items-start gap-2 flex-1">
                                        ...
                                        {{-- Marca → selector de marca + modelos encadenados --}}
    ...
    function cuponesPage() {
        return {
            ...
            // ── Validación ───────────────────────────────────────────────────
            get formValido() {
                // Sucursal presente (valor puede ser "" = todas)
            ...
            abrirCrear() {
                ...
                this.form = {
                    ...
                    aplica_a: 'total', id_producto_gratis: '',
                    usos_maximos: '', fecha_inicio: '', fecha_fin: '',
            ...
            async abrirEditar(cupon) {
                ...
                this.form = {
                    ...
                    reglas:             reglas.map(r => ({
                        tipo:         r.tipo,
                        valor:        r.valor ?? '',
                        valor_modelo: '',   // se reconstruye abajo si aplica
                    })),
                };
                ...
                if (regMarca?.valor) {
                    ...
                    // Si además había regla de modelo para esa marca, preseleccionarla
            ...
            // ── Modelos por marca (AJAX usando CatalogService cacheado) ───────
            ...
            async submitCrear() {
                ...
                for (const r of this.form.reglas) {
                    if (r.tipo === 'marca') {
                        ...
                        if (r.valor_modelo) {
                            reglas.push({ tipo: 'modelo', valor: r.valor_modelo });
                        }
                    } else {
                ...
                const payload = { ...this.form, reglas };
